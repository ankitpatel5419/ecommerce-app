...
//   const { prodcuts , currency , cartItems } = useContext(ShopContext);
...
//             const productData = prodcuts.find( (product ) => product._id === item._id )
          
//             return(
//               <div key={index} className='py-4 border-t border-b text-gray-700 grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2f4_0.5fr] items-center gap-4'>
